...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-1/3 flex flex-col">
        ...
        <select id="parent-region" class="w-auto py-2 border border-gray-300 rounded-md">
    ...
    <div class="w-1/3 flex flex-col mt-4 md:mt-0">
        ...
        <select id="sub-region" name="region_id" class="w-auto py-2 border border-gray-300 rounded-md">
    ...
    <!-- 住所詳細の入力 -->
    <!-- <div class="w-1/3 flex flex-col mt-4 md:mt-0">
        <label for="address-detail" class="font-semibold leading-none mt-4">住所詳細 (〇丁目〇番〇号等)</label>
        <input type="text" name="address_detail" id="address-detail" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" placeholder="〇丁目〇番〇号等">
    </div> -->
...
<script>
    const parentRegionSelect = document.getElementById('parent-region');
